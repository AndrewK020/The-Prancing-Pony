...
VALUES
    ('John', 'Doe', 'john.doe@me.com', '214-300-5000', NOW(), NOW()),
...
INSERT INTO Rooms
    (type, roomNumber, price, createdAt, updatedAt)
VALUES
    ('double', 451, 34.99, NOW(), NOW()),
...
INSERT INTO Reservations
    (checkInDate, checkOutDate, createdAt, updatedAt)
VALUES
    (NOW(), NOW(), NOW(), NOW());

UPDATE Guests AS g, Rooms as r
SET  g
.ReservationId = 1, r.ReservationId = 1
